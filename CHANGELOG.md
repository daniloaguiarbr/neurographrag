...
- `--lang` now accepts `en`/`pt` short codes as documented (previously required full identifiers `english`/`portugues`). Aliases added: `en/english/EN`, `pt/portugues/portuguese/pt-BR/pt-br/PT`.
