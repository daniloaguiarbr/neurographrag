[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](CODE_OF_CONDUCT.pt-BR.md)

Leia este documento em [inglês (EN)](CODE_OF_CONDUCT.md).
...
## Nosso Compromisso
- Nós, membros, contribuidores e líderes, nos comprometemos a tornar a participação livre de assédio
- Nos comprometemos a manter nossa comunidade acolhedora para todos independentemente de idade ou porte
- Nos comprometemos a receber participantes com deficiência visível ou invisível e qualquer etnia
- Nos comprometemos a receber todas as características sexuais, identidade e expressão de gênero
- Nos comprometemos a receber todo nível educacional, status socioeconômico, nacionalidade, aparência
- Nos comprometemos a receber toda raça, casta, cor, religião, identidade ou orientação sexual
- Nos comprometemos a agir e interagir de maneiras que contribuam para uma comunidade acolhedora
- Nos comprometemos a agir e interagir construindo uma comunidade diversa, inclusiva e saudável
...
- Aprender com a experiência e melhorar comportamentos futuros
...
- Publicar informações privadas de outras pessoas como endereço físico ou email sem permissão
- Outras condutas que razoavelmente sejam consideradas inapropriadas em ambiente profissional


## Responsabilidades de Aplicação
- Líderes da comunidade são responsáveis por esclarecer e aplicar nossos padrões de comportamento
- Líderes da comunidade tomarão ação corretiva apropriada e justa em resposta a qualquer comportamento
- Líderes têm o direito e a responsabilidade de remover, editar ou rejeitar comentários, commits, código
- Líderes podem remover edições de wiki, issues e outras contribuições não alinhadas a este Código
- Líderes comunicarão razões para decisões de moderação quando apropriado


## Escopo
- Este Código de Conduta se aplica dentro de todos os espaços da comunidade
- Este Código se aplica quando um indivíduo representa oficialmente a comunidade em espaços públicos
- Exemplos de representação da comunidade incluem uso de email oficial
- Exemplos incluem postagem via conta oficial de rede social
- Exemplos incluem atuação como representante designado em evento online ou presencial
...
- O Contributor Covenant está disponível em https://www.contributor-covenant.org/version/2/1/code_of_conduct.html
- Diretrizes de Impacto Comunitário foram inspiradas pela escada de aplicação da Mozilla
- Para respostas a perguntas comuns consulte o FAQ em https://www.contributor-covenant.org/faq
